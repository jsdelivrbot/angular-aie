    ...
    initScreen() {
        ...
        if (this.repairclass == 123) {
            ...
            if (this.hasEditAccess) {
                ...
                document.getElementById("savebbNote1"  )["style"]["visibility"] = "visible";
                document.getElementById("savebbNote2"  )["style"]["visibility"] = "visible";                        
            }
            else {
                document.getElementById("savebbButton1")["style"]["display"   ] = "none";
                document.getElementById("savebbButton2")["style"]["display"   ] = "none";                        
                document.getElementById("savebbNote1"  )["style"]["display"   ] = "none";
                document.getElementById("savebbNote2"  )["style"]["display"   ] = "none";
            }
        }
        else {
            document.getElementById("savebbButton1"    )["style"]["display"   ] = "none";
...
//      this.haveNoPage = true;
    ...
    subscribeAiedec(len, i) {
        this.aieDecisionService.submitAiedec(len, i, this.selectedLID)
            .subscribe(
                result => {
                    this.result = result;
