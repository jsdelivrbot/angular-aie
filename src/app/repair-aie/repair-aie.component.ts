...
export class RepairAieComponent implements OnInit  {
    ...
    ngAfterViewInit() {
      ...
      //console.log("done");
        ...
        console.log("this.dataService.currentHostName.subscribe(host => this.host = host);", this.host);
        console.log("this.dataService.currentLid.subscribe(customerLid => this.customerLid = customerLid);", this.customerLid);
